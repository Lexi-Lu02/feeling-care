          ...
          <div class="row align-items-center">
            <div class="col-12 col-lg-8">
              ...
              <p class="hero-description">
                Join us in making a difference in mental health awareness and support. There are
                many ways you can contribute to our mission and help create a more compassionate
                community.
              </p>
            </div>
            ...
            <div class="col-lg-6">
              <div class="section-content">
                ...
                <p class="section-description">
                  ...
                  platform, and reach more people in need. Every donation, no matter the size, makes
                ...
                <form @submit.prevent="submitStory">
                  ...
                  <div class="email-field">
                    ...
                    <div id="story-type-description" class="form-text">
                      Choose the format for your story. You can share a written story, record an
                      audio message, or upload a video.
                    </div>
                  </div>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="section-content">
                ...
                <p class="section-description">
                  Are you a mental health professional, researcher, or expert? Share your knowledge
                  to help educate our community and provide evidence-based information that can make
                  a real difference.
                </p>
                <ul class="benefits-list">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6 order-lg-2">
              <div class="section-content">
                ...
                <p class="section-description">
                  Become an active member of our community. Join our volunteer program, participate
                  in events, or become a community moderator. Together, we can create a more
                  supportive and understanding world.
                </p>
                <ul class="benefits-list">
      ...
      <div v-if="showPrivacyModal" class="privacy-modal-overlay" @click="showPrivacyModal = false">
        <div class="privacy-modal" @click.stop>
          ...
          <div class="privacy-modal-content">
            ...
            <p>
              When you share your story with us, we collect the information you provide including
              your story content, title, and any media files you upload. This information is used
              to:
            </p>
            <ul>
            ...
            <h4>Your Rights</h4>
            <p>
              You have the right to request the deletion of your story or personal information at
