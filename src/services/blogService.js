...
// Function to get first-person story content based on post ID
export const getStoryContent = (postId) => {
  const stories = {
    1: {
  ...
  return (
    stories[postId] || {
      ...
      content: `
      <h2>My Personal Journey</h2>
      <p>This is a personal story about my experiences and insights related to this important topic. Through my work and personal journey, I've learned valuable lessons that I'm passionate about sharing with others.</p>

      <p>Every story is unique, and every person's experience matters. What I've discovered is that the most powerful healing often comes from sharing our stories and supporting each other through life's challenges.</p>

      <h3>Key Insights</h3>
      <p>Through my journey, I've learned that compassion, understanding, and connection are the foundation of mental health and wellbeing. When we support each other and share our experiences, we create a stronger, more resilient community.</p>
    `,
    }
  )
}
